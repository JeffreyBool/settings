...
class SettingsTest extends TestCase
{
    ...
    public function testHasReturnRepositoryValue()
    {
        ...
        $settings = new \JeffreyBool\Settings\Settings($mock, $g, $valueSerializer);
    ...
    {
        $context1 = new \JeffreyBool\Settings\Context();

        $context2 = new \JeffreyBool\Settings\Context();
    ...
    {
        return m::mock('JeffreyBool\Settings\Contracts\Repository');
    }
    ...
    {
        return m::mock('JeffreyBool\Settings\Contracts\KeyGenerator');
    }

    protected function getValueSerializerMock()
    {
        return m::mock('JeffreyBool\Settings\Contracts\ValueSerializer');
    }
}
